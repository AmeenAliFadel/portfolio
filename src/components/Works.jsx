  ...
  return (
    ...
    >
      <Tilt
        ...
        className=" bg-tertiary p-5 rounded-2xl w-full md:w-90  "
      >
  ...
  return (
    <>
      ...
      <div className=" w-full flex ">
        ...
        >
          Here are some of the projects I've built, highlighting my experience with modern web technologies and clean UI design.
        </motion.p>
      </div>
